...
class X402Client {
    ...
    async fetchData(request) {
        ...
        try {
            ...
            const response = await this.makeRequest(request.endpoint, request.params, requestId);
            return response;
        }
        catch (error) {
            // Log failed attempt
     ...
     */
    async createPaymentProof(challenge) {
        switch (this.config.method) {
            case x402Types_1.PaymentMethod.MOCK:
                return this.createMockProof(challenge);
            case x402Types_1.PaymentMethod.BLOCKCHAIN:
                return this.createBlockchainProof(challenge);
            case x402Types_1.PaymentMethod.CACHED:
     ...
     */
    async createBlockchainProof(challenge) {
