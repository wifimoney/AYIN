...
require('../../../dist/contract-publisher-e313f514.cjs.prod.js');
require('@thirdweb-dev/contracts-js/dist/abis/ContractPublisher.json');
require('../../../dist/transactions-e6d96ab6.cjs.prod.js');
...
require('../../../dist/fetchCurrencyValue-66aab53a.cjs.prod.js');
require('../../../dist/normalizePriceValue-5f7fd2f0.cjs.prod.js');
require('@thirdweb-dev/generated-abis');
require('../../../dist/deployContractDeterministic-b58258cf.cjs.prod.js');
...
async function zkVerify(contractAddress, chainId, explorerAPIUrl, explorerAPIKey, storage, metadataUri, zkVersion, encodedConstructorArgs) {
  try {
    ...
    const sources = await fetchSourceFilesFromMetadata.fetchSourceFilesFromMetadata(compilerMetadata, storage);
...
async function zkDeployContractDeterministic(signer, transaction, storage, metadataUri, options) {
  ...
  if (!contractDeployed) {
    ...
    const salt = options?.saltForProxyDeploy ? ethers.utils.id(options.saltForProxyDeploy) : ethers.utils.id("thirdweb");
  ...
  if (extendedMetadata && extendedMetadata.factoryDeploymentData && !forceDirectDeploy && (!extendedMetadata.deployType || extendedMetadata.deployType !== "standard")) {
    ...
    if (directDeployDeterministic && !deterministicDeployment) {
      ...
      const tx = {
        ...
        to: create2Factory,
        constructorCalldata: ethers.utils.arrayify(encodedArgs),
        bytecode,
        bytecodeHash: ethers.utils.hexlify(utils$1.hashBytecode(bytecode)),
