...
export declare const coreContractAbi: ({
    type: string;
    stateMutability: string;
    name?: undefined;
    inputs?: undefined;
...
export declare const extensionContractAbi: {
    type: string;
    name: string;
    inputs: never[];
    outputs: {
...
export declare const FEATURE_MODULAR_CORE: {
    readonly name: "ModularCore";
    readonly namespace: "modular.core";
    readonly docLinks: {
        readonly sdk: "";
        readonly contracts: "";
    };
...
export declare const FEATURE_MODULAR_EXTENSION: {
    readonly name: "ModularExtension";
    readonly namespace: "modular.extension";
    readonly docLinks: {
        readonly sdk: "";
        readonly contracts: "";
    };
